...
import { ref } from 'vue';
import DataChart from '@/components/shared/DataChart.vue';
import type { TBarChartOption, TPieChartOption } from '@/types/chart.type';
import { employeeList } from '@/data/employees.data';
